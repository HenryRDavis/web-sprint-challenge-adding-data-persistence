...
1. Explain the difference between `Relational Databases` and `SQL`.
 -- The difference between SQL and relational databases is that SQL is a language where relational databases are usually softwares to manage the data. SQL is optimized for the sole purpose of querying data.
2. Why do tables need a `primary key`?
-- Primary key identifies the uniqueness of a row
3. What is the name given to a table column that references the primary key on another table. Its called the foreign key.

4. What do we need in order to have a _many to many_ relationship between two tables.
We're supposed to have Foreign keys & have a third table.
